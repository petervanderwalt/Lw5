...
'  var gcode = "";',
                        ...
                        '    }',
                                ...
                                var millWorkerCode = [
                                    ...
                                    '}',
                                    '',
                                    'var moduleReady = new Promise(function(r) { if (typeof Module === "undefined") { r(); return; } if (Module._vCarve) { r(); return; } var c = Module.onRuntimeInitialized; Module.onRuntimeInitialized = function() { if (c) c(); Module["HEAPU32"] = HEAPU32; Module["HEAP8"] = HEAP8; Module["HEAP32"] = HEAP32; r(); }; setTimeout(function() { r(); }, 3000); });',
